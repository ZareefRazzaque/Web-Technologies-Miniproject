<?php
    ...
    if(!($_SESSION["active"] == "true")){
        header("Location: ../notloggedin/blog.php");
...
<html>
    ...
    <body>
        ...
        <div class = "topofpage" id="top">
            ...
            <header class="pagetitle">-Blog</header>
        </div>
        ...
        <main>
            <section class= "blogsection">
                ...
                <form  method="GET" action="../phpstuff/addblog.php" id="form">
                    <header>Add Blog Entry </header> <br>
                    Blog Title: <br>
                    <input type="text" name="BlogTitle" class="blogtitle" > <br>

                    Details: <br>
                    <textarea name="NewBlog" id="NewBlog" class = "test" cols="30" rows="10"></textarea> <br>
                ...
                <?php
                    ...
                    $savedDetails = mysqli_query($connection, "SELECT * FROM blogs");
                    $pastblogs = array();
                ...
                <article class="article">
                    <header class = "header">End of Blog</header>
                        <p class = "para">
                            You have reached the end of my blog! Thank you for reading this far.
                        </p>
                </article>
