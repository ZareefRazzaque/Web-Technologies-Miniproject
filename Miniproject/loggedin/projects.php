<?php
    ...
    if(!($_SESSION["active"] == "true")){
        header("Location: ../notloggedin/projects.php");
...
<head>
    ...
    <body>
        ...
        <div class = "topofpage" id="top">
            ...
            <header class="pagetitle">-Projects</header>
        </div>
        ...
        <header class="title" >My Projects</header>
        ...
        <main>
            <section class= "blogsection">
                <article class="introduction">
                    ...
                    <header class= "experiance">Welcome to My Projects, <br>
                        here are some of my past and current projects that I have undertaken 
                    </header>
                ...
                <form  method="GET" action="../phpstuff/addproject.php" id = "form">
                    <header>Add project</header> <br>
                    Project Title: <br>
                    <input type="text" name="ProjectTitle" class="blogtitle" > <br>

                    Details: <br>
                    <textarea name="Newproject" id="newproject" cols="30" rows="10"></textarea> <br>
                ...
                <?php
                    ...
                    $savedDetails = mysqli_query($connection, "SELECT * FROM projects");
                    $pastblogs = array();
